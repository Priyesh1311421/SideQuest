    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <Card className="mb-12 shadow-md">
                    <CardContent className="p-6 md:p-8">
                        <h2 className="text-3xl font-bold mb-6 text-gray-800">Cuisine</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {storyData.food && storyData.food.map((item, index) => (
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <button
                                                ...
                                                aria-label={expandedFoods[index] ? "Collapse details" : "Expand details"}
                                            >
                                                {expandedFoods[index] ? (
                                                    <ChevronUp size={20} />
                                                ) : (
                ...
                <Card className="mb-12 shadow-md">
                    <CardContent className="p-6 md:p-8">
                        <h2 className="text-3xl font-bold mb-6 text-gray-800">Festivals</h2>
                ...
                <Card className="mb-12 shadow-md">
                    <CardContent className="p-6 md:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {storyData.art && storyData.art.map((artForm, index) => (
                                <Card
                                    key={index}
                ...
                <Card className="mb-12 shadow-md">
                    <CardContent className="p-6 md:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {storyData.music && storyData.music.map((item, index) => (
                ...
                <Card className="mb-12 shadow-md">
                    <CardContent className="p-6 md:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {storyData.touristAttractions && storyData.touristAttractions.map(
                                (place, index) => (
                                    <Card key={index} className="p-4 hover:shadow-lg transition-shadow duration-300">
                                        <h3 className="text-xl font-bold mb-2 text-gray-800">
                                            {place.name}
