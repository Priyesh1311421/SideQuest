  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6 text-center">
        ...
        {remoteEmailId ? (
          <h2 className="text-xl text-green-600">Connected with: {remoteEmailId}</h2>
        ) : (
          <h2 className="text-xl text-gray-500">Waiting for someone to join...</h2>
        )}
      </div>
        ...
        <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
          ...
          <div className="aspect-video bg-black">
            {remoteStream ? (
              ...
              <div className="flex items-center justify-center h-full text-white">
                {isConnected ? "Waiting for remote video..." : "No one connected yet"}
              </div>
            )}
          </div>
        </div>
